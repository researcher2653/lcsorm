...
# Constant Change and Intercept - Constant Change Components Constrained to Zero
B0 =~ 1*lpay1		
...
pay_sat3 ~ 0 
pay_sat4 ~ 0'
IO.fit<-sem(IO.Model, data=mydata, missing = "fiml", estimator ="ml")
summary (IO.fit, fit.measures = T)
